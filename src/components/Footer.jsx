    ...
    return (
        <div className="bg-white flex justify-center items-center pl-6 pr-6 h-28 gap-12">
            ...
            <div className="text-[#1F2329] grid grid-cols-2 w-[50%] sm:w-auto sm:flex sm:gap-6">
                ...
                <a target="_blank" href="https://api.whatsapp.com/send?phone=5511990246137"><IoLogoWhatsapp size={24} className="m-2 hover:opacity-40 transition-all cursor-pointer" /></a>
            </div>
        </div>
    )
}