...
function App() {
  return (
    <div id="container" className="flex flex-col justify-center items-center">
      <div className="2xl:w-[740px]">
        <div className="w-[100%] h-[100vh] flex flex-col">
          <Header />
          <div className="pb-8">
            <div className="flex flex-col md:flex-row md:justify-between items-center">
              <div className="flex flex-col md:w-[100%] 2xl:mt-32">
                <div className="flex flex-row gap-6 items-center"><h1 className="text-[22px] sm:text-5xl font-montserrat font-bold text-[#212121]">Bruno Bertholini</h1><a target="_blank" href="https://www.linkedin.com/in/bruno-bertholini/" className="cursor-pointer bg-green-500 border border-[#212121] border-opacity-30 hover:shadow-green-500/20 hover:scale-110 transition-all hover:shadow-lg drop-shadow-lg h-fit pl-3 pr-3 rounded-full text-[#212121]">Open to work</a></div>
                ...
                <div className="sm:flex flex-row justify-between 2xl:mt-8">
